...
import { ChevronLeft, MapPin, Truck, Camera, CheckCircle, HelpCircle, Gauge, X } from 'lucide-react';
            ...
            <div className="container" style={{ paddingTop: '1.5rem' }}>
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        <Camera size={22} /> Registrar Pesaje
                    </button>
                    <button
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button
                            ...
                            disabled={finishing || !kmEnd.trim()}
                            style={{
                                width: '100%',
                                background: (kmEnd.trim() && !finishing) ? 'var(--primary-gradient)' : '#E5E7EB',
                                color: (kmEnd.trim() && !finishing) ? 'white' : '#9CA3AF',
                                border: 'none', padding: '1rem',
                                borderRadius: '16px', fontWeight: '800',
                                fontSize: '1rem', cursor: (kmEnd.trim() && !finishing) ? 'pointer' : 'not-allowed',
                                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem',
                                boxShadow: kmEnd.trim() ? 'var(--shadow-red)' : 'none'
                            }}
                        >
                            <CheckCircle size={22} />
